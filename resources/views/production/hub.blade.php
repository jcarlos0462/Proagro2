...
<div class="app-shell">
    ...
    <div class="app-main">
        ...
        <main class="page">
            <div class="nav-row">
                <a class="back-btn" href="{{ route('apt.production') }}">
            ...
            <div class="hub-grid">
                <a href="{{ route('apt.management') }}" class="hub-card hub-card-blue">
                ...
                <a href="{{ route('apt.management.lots.report') }}" class="hub-card hub-card-emerald">
                ...
                @if($isJefeOrAdmin)
                <a href="{{ route('apt.management.assignments.control') }}" class="hub-card hub-card-rose">
