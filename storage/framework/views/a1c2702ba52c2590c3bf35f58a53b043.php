...
<div class="app-shell">
    ...
    <main class="page">
        ...
        <div class="shell">
                                ...
                                <div class="lot-checkboxes">
                                    <?php $__currentLoopData = $lots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="lot-checkbox">
                                            <input type="checkbox" name="lot_ids[]" value="<?php echo e($l->id); ?>" data-lot-name="<?php echo e($l->folio); ?>">
            ...
            <div class="form-body">
                <div class="form-top-bar">
                    <p><?php echo e($latestRegistration ? 'Información del lote y turno asignado por el Jefe de Almacén.' : 'Información del turno y lote en recepción (Sin lote asignado).'); ?></p>
                    <span><?php echo e($latestRegistration ? 'Lote activo' : 'Sin datos'); ?></span>
                </div>
                ...
                <div class="grid-3" style="margin-bottom: 1.5rem;">
                    <div class="field-group">
                        <div>
                            ...
                            <div class="field-control" style="background: var(--slate-50); color: var(--slate-800); font-weight: 700;">
                                <?php echo e($latestRegistration ? ($latestRegistration->user?->name ?: auth()->user()->name) : (auth()->user()->name ?: '—')); ?>

                            </div>
                        </div>
                        <div>
                            <span class="field-label"><i class="fa-solid fa-clipboard-list"></i> Turno</span>
                            <div class="field-control" style="background: var(--slate-50); color: <?php echo e($latestRegistration ? 'var(--slate-800)' : 'var(--slate-400)'); ?>; font-weight: 700;">
                                <?php echo e($latestRegistration ? $latestRegistration->shift : '—'); ?>
                    ...
                    <div class="field-group">
                        <div>
                            <span class="field-label"><i class="fa-solid fa-id-badge"></i> Puesto</span>
                            <div class="field-control" style="background: var(--slate-50); color: var(--slate-800); font-weight: 700;">
                                <?php echo e($latestRegistration ? ($latestRegistration->position ?: 'Almacén') : (auth()->user()->position ?: 'Almacén')); ?>

                            </div>
                        </div>
                        <div>
                            <span class="field-label"><i class="fa-solid fa-box-open"></i> Lote en recepción</span>
                            <div class="field-control" style="background: <?php echo e($latestRegistration ? '#eff6ff' : 'var(--slate-50)'); ?>; color: <?php echo e($latestRegistration ? '#1d4ed8' : 'var(--slate-400)'); ?>; font-weight: 800; border-color: <?php echo e($latestRegistration ? '#bfdbfe' : 'var(--slate-200)'); ?>;">
                                <?php echo e($latestRegistration ? ($latestRegistration->lot?->folio ?: 'Lote asignado') : '—'); ?>
...
<?php /**PATH C:\xampp\htdocs\Proagroindustria2\resources\views/production/management.blade.php ENDPATH**/ ?>