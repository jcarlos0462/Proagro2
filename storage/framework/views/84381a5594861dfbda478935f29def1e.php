            ...
            <div class="app-user-card">
                <div class="app-user-inner">
                    ...
                    <div class="app-user-meta">
                        ...
                        <p class="app-user-role"><?php echo e($userRole); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <main class="page">
            ...
            <section class="summary" aria-label="Resumen de asignaciones">
                <div class="summary-card">
                    ...
                    <div class="summary-content">
                        <span class="summary-value" data-summary-users><?php echo e($summary['users'] ?? $assignments->count()); ?></span>
                ...
                <div class="summary-card">
                    ...
                    <div class="summary-content">
                        <span class="summary-value" data-summary-total><?php echo e($summary['total'] ?? 0); ?></span>
                ...
                <div class="summary-card">
                    ...
                    <div class="summary-content">
                        <span class="summary-value" data-summary-open><?php echo e($summary['open'] ?? 0); ?></span>
                ...
                <div class="summary-card">
                    ...
                    <div class="summary-content">
                        <span class="summary-value" data-summary-closed><?php echo e($summary['closed'] ?? 0); ?></span>
                        <span class="summary-label">Lotes cerrados</span>
                    </div>
                </div>
            </section>

            <form class="filter-panel" method="GET" action="<?php echo e(route('apt.management.assignments.control')); ?>">
                <div class="filter-field">
                    <label for="filterSearch">Buscar usuario, lote o turno</label>
                    <input type="search" id="filterSearch" name="search" class="filter-input" value="<?php echo e($search); ?>" placeholder="Ej. Eduardo, PA2026, Turno 2...">
                </div>
                <div class="filter-field" style="max-width: 220px;">
                    <label for="filterStatus">Estado</label>
                    <select id="filterStatus" name="status" class="filter-input">
                        <option value="all" <?php echo e($statusFilter === 'all' ? 'selected' : ''); ?>>Todos</option>
                        <option value="open" <?php echo e($statusFilter === 'open' ? 'selected' : ''); ?>>Solo abiertos</option>
                        <option value="closed" <?php echo e($statusFilter === 'closed' ? 'selected' : ''); ?>>Solo cerrados</option>
                    </select>
                </div>
                ...
                <a href="<?php echo e(route('apt.management.assignments.control')); ?>" class="filter-clear">
            ...
            <section class="table-card">
                <div class="table-header-box">
                    ...
                    <span><?php echo e($assignments->count()); ?> <?php echo e($assignments->count() === 1 ? 'usuario registrado' : 'usuarios registrados'); ?></span>
                </div>
                    ...
                    <table>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr data-assignment-row>
                                <td>
                                    <div class="user-cell">
                                        <div class="user-avatar-small"><?php echo e($userInitial); ?></div>
                                        <span class="user-name-text"><?php echo e($assignment['user_name']); ?></span>
                                    </div>
                                </td>
                                <td>
                                    <?php if($lotsCount > 1): ?>
                                        <select class="lot-select" data-lot-select aria-label="Lotes de <?php echo e($assignment['user_name']); ?>">
                                            <?php $__currentLoopData = $assignment['lots']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                ...
                                                ?>
                                                <option value="<?php echo e($l->production_shift_start_id); ?>|<?php echo e($l->lot_id); ?>"
                                                    <?php echo e($loop->first ? 'selected' : ''); ?>

                                                    data-folio="<?php echo e($l->lot_folio); ?>"
                                                    data-warehouse="<?php echo e($l->warehouse ?: ''); ?>"
                                                    data-status="<?php echo e($isClosed ? 'closed' : 'open'); ?>"
                                                    data-shift="<?php echo e($l->shift ?: '—'); ?>"
                                                    data-started-at="<?php echo e($startedFormatted); ?>"
                                                    data-closed-at="<?php echo e($closedFormatted); ?>"
                                                    data-closed-by="<?php echo e($l->closed_by_name ?: ''); ?>"
                                                    data-close-url="<?php echo e(route('apt.management.activity.lot.close', ['shiftStart' => $l->production_shift_start_id, 'lot' => $l->lot_id])); ?>"
                                                    data-reopen-url="<?php echo e(route('apt.management.activity.lot.reopen', ['shiftStart' => $l->production_shift_start_id, 'lot' => $l->lot_id])); ?>"
                                                ><?php echo e($lotLabel); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    <?php elseif($lotsCount === 1): ?>
                                        <?php
                                        ...
                                        <div class="single-lot-badge"
                                            data-single-lot
                                            data-folio="<?php echo e($firstLot->lot_folio); ?>"
                                            data-warehouse="<?php echo e($firstLot->warehouse ?: ''); ?>"
                                            data-status="<?php echo e($firstClosed ? 'closed' : 'open'); ?>"
                                            data-shift="<?php echo e($firstLot->shift ?: '—'); ?>"
                                            data-started-at="<?php echo e($startedFormatted); ?>"
                                            data-closed-at="<?php echo e($closedFormatted); ?>"
                                            data-closed-by="<?php echo e($firstLot->closed_by_name ?: ''); ?>"
                                            data-close-url="<?php echo e(route('apt.management.activity.lot.close', ['shiftStart' => $firstLot->production_shift_start_id, 'lot' => $firstLot->lot_id])); ?>"
                                            data-reopen-url="<?php echo e(route('apt.management.activity.lot.reopen', ['shiftStart' => $firstLot->production_shift_start_id, 'lot' => $firstLot->lot_id])); ?>"
                                        >
                                            <i class="fa-solid fa-box-archive"></i>
                                            <span><?php echo e($firstLot->lot_folio); ?><?php echo e($firstLot->warehouse ? ' · ' . $firstLot->warehouse : ''); ?></span>
                                        </div>
                                    <?php else: ?>
                                ...
                                <td>
                                    <span data-shift-text><?php echo e($firstLot ? ($firstLot->shift ?: '—') : '—'); ?></span>
                                </td>
                                <td>
                                    <span data-started-text><?php echo e($firstLot && $firstLot->started_at ? \Carbon\Carbon::parse($firstLot->started_at)->format('d/m/Y H:i') : '—'); ?></span>
                                </td>
                                <td>
                                    <span class="badge <?php echo e($firstClosed ? 'closed' : 'open'); ?>" data-status-badge>
                                        <i class="fa-solid <?php echo e($firstClosed ? 'fa-lock' : 'fa-lock-open'); ?>"></i>
                                        <span><?php echo e($firstClosed ? 'Cerrado' : 'Abierto'); ?></span>
                                    </span>
                                    <span class="date-sub" data-closed-meta style="<?php echo e($firstClosed && $firstLot->closed_at ? '' : 'display:none;'); ?>">
                                        <?php if($firstClosed && $firstLot->closed_at): ?>
                                            Cerrado: <?php echo e(\Carbon\Carbon::parse($firstLot->closed_at)->format('d/m/Y H:i')); ?>

                                            <?php echo e($firstLot->closed_by_name ? ' por ' . $firstLot->closed_by_name : ''); ?>
                                ...
                                <td>
                                    <div class="actions-group">
                                        <button type="button" class="action-btn close" data-close-btn style="<?php echo e($firstClosed ? 'display:none;' : ''); ?>">
                                            <i class="fa-solid fa-lock"></i> Cerrar lote
                                        </button>
                                        <button type="button" class="action-btn reopen" data-reopen-btn style="<?php echo e($firstClosed ? '' : 'display:none;'); ?>">
...
<?php /**PATH C:\xampp\htdocs\Proagroindustria2\resources\views/production/assignments-control.blade.php ENDPATH**/ ?>